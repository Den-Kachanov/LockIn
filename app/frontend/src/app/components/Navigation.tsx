...
const navItems = [
  ...
  { id: 'casino', label: 'Lucky Charm', icon: Coins },
      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-3 md:mb-4">
          <div className="flex items-center gap-2 md:gap-3">
            ...
            <div>
              <h1 className="text-lg md:text-2xl text-transparent bg-clip-text" style={{ fontWeight: 800, backgroundImage: `linear-gradient(to right, ${currentTheme.primary}, ${currentTheme.secondary})` }}>
                UCU LOCK IN
              </h1>
          ...
          <div className="flex items-center gap-2 md:gap-4">
            ...
            <div className="text-right">
              ...
              <div className="text-sm md:text-xl font-bold" style={{ color: currentTheme.accent }}>
          ...
          {navItems.map((item) => {
            ...
            return (
              <motion.button
                ...
                className={`relative px-3 md:px-6 py-2 md:py-3 rounded-xl font-semibold whitespace-nowrap transition-colors text-xs md:text-base ${isActive ? 'text-white' : 'text-white/50 hover:text-white/80'}`}
              ...
              >
                {isActive && (
                  <motion.div
                    ...
                    style={{ background: `linear-gradient(to right, ${currentTheme.primary}30, ${currentTheme.secondary}30)`, borderColor: `${currentTheme.primary}80` }}
                    layoutId="activeTab"
